export const API_ENDPOINTS = {
  ...
  security: {
    ...
    zonePrecheck: '/security/zones/precheck',
    armZones: '/security/zones/arm',
    disarmZones: '/security/zones/disarm',
    acknowledgeZone: (zoneCode: string) =>
      `/security/zones/${encodeURIComponent(zoneCode)}/acknowledgement`,
  ...
  realtime: {
    ...
    securityZones: '/topic/security/zones',
